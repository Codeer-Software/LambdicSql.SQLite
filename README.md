LambdicSql for SQLite_β 0.5.0
======================

## Features ...
LambdicSql is ultimate sql builder.<br>
Generate sql text and parameters from lambda. <br>
We will make it possible to represent as many SQLite clause and functions as possible in C #. <br>
...
https://www.nuget.org/packages/LambdicSql.SQLite/<br>
...
namespace Sample
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //test.
            using (var cnn = new SQLiteConnection("your connection string")) Sample(cnn);
        }
